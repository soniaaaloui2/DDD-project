...
def test_find_en_attente_validation():
    ...
    # Act
    pending = repo.find_en_attente_validation()
...
def test_count_by_statut():
    ...
    # Act & Assert
    assert repo.count_by_statut(StatutDemande.en_attente_validation()) == 2
    assert repo.count_by_statut(StatutDemande.validee()) == 1
    assert repo.count_by_statut(StatutDemande.rejetee()) == 0
...
if __name__ == '__main__':
    test_save_and_find()
    test_find_by_email()
    test_find_en_attente_validation()
